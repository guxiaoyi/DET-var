...
class DTree
{
 public:
  ...
  void ComputeLossReduction(MatType& data,
                            const size_t maxLeafSize = 10,
                            const size_t minLeafSize = 5,
                            const size_t mtry = 1);
    
  void GrowOnce(MatType& data,
  ...
  void SetMask(std::unordered_set<size_t> mask);
    
  void SetCondMask(std::unordered_set<size_t> condMask);
 ...
 public:
  ...
  std::string Criterion() const { return criterion; }
    
  std::unordered_set<size_t> GetMask() const { return mask; }
    
  std::unordered_set<size_t> GetCondMask() const { return condMask; }
